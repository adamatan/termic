...
/// Project (source of truth, editable) and the Task (frozen copy
...
pub struct SshTarget {
    ...
    /// expanded remotely at task-create time.
...
/// Where a task's processes and files live. Threaded through the
