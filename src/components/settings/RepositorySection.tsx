        ...
        <div className="flex flex-col gap-7">
          ...
          {isRemote && draft.ssh && (
            <div className="rounded-md border border-[var(--color-border-soft)] p-4">
              ...
              <div className="mt-0.5 text-[12.5px] text-[var(--color-fg-dim)]">
                Applies to NEW tasks. Existing tasks keep the connection
                they were created with, so edits here can't silently
                repoint live worktrees at a different machine.
              </div>
